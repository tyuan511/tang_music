...
class _PlayerState extends State<Player> {
  Widget progressBar(PlayerStore player) {
    return Padding(
  ...
  Widget playerControl(PlayerStore player) {
    return Padding(
  ...
  Widget build(BuildContext context) {
    return Consumer<PlayerStore>(
        builder: (context, player, child) => Scaffold(
              ...
              body: Column(
                ...
                children: [
                  ...
                  Column(
                    children: [progressBar(player), playerControl(player)],
                  )
                ],
              ),
            ));
